...
//static GUID MEDIASUBTYPE_MPEG2DATA = {0xc892e55b, 0x252d, 0x42b5, {0xa3, 0x16, 0xd9, 0x97, 0xe7, 0xa5, 0xd9, 0x95}};

//OUR_GUID_ENTRY(MEDIASUBTYPE_DVB_SI,
//0xe9dd31a3, 0x221d, 0x4adb, 0x85, 0x32, 0x9a, 0xf3, 0x9, 0xc1, 0xa4, 0x8)
//static GUID MEDIASUBTYPE_DVB_SI = {0xe9dd31a3, 0x221d, 0x4adb, {0x85, 0x32, 0x9a, 0xf3, 0x9, 0xc1, 0xa4, 0x8}};
...
HRESULT Demux::CheckDemuxPids(PidParser *pPidParser)
{
	...
	if (m_SelAudioPid &&
		((m_SelAudioPid == pPidParser->pids.aac2)||
		 (m_SelAudioPid == pPidParser->pids.aac)))
		 if ((m_SelAudioType.majortype != MEDIATYPE_Audio)||
			 (m_SelAudioType.subtype != MEDIASUBTYPE_AAC)) //MEDIASUBTYPE_AAC4))
			return S_FALSE;
