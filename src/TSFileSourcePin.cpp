...
//PrintTime("get lastpcr failed now using first pcr", (__int64)m_pTSFileSourceFilter->m_pPidParser->pids.start, 90);
...
//*******************************************************************************************
	...
	if (readonly)
	{
		...
		if (m_DataRate > 0 && !m_pTSFileSourceFilter->m_pPidParser->get_ProgPinMode()) {
