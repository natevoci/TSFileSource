...
#ifndef MULTIMEMREADER_H
#define MULTIMEMREADER_H

#include "MemReader.h"
#include "SharedMemory.h"
#include <vector>

class MultiMemReaderFile
{
public:
	LPWSTR filename;
...
class MultiMemReader : public FileReader
{
public:
...
protected:
	...
	std::vector<MultiMemReaderFile *> m_tsFiles;
